...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Segreto Core segreto-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  segreto-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded segreto transaction") + "\n" +
                               "  segreto-tx [options] -create [commands]   " + _("Create hex-encoded segreto transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded segreto transaction
