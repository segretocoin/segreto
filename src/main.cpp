...
#if defined(NDEBUG)
#error "Segreto cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usgo) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 5 * COIN;
    } else if (nHeight >= 15082 && nHeight <= 25162) {
        nSubsidy = 7 * COIN;
    } else if (nHeight >= 25163 && nHeight <= 35243) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 35244 && nHeight <= 45324) {
        nSubsidy = 13 * COIN;
    } else if (nHeight >= 45325 && nHeight <= 55405) {
        nSubsidy = 15 * COIN;
    } else if (nHeight >= 55406 && nHeight <= 65486) {
        nSubsidy = 17 * COIN;
    } else if (nHeight >= 65487 && nHeight <= 75567) {
        nSubsidy = 20 * COIN;
    } else if (nHeight >= 75568 && nHeight <= 85648) {
        nSubsidy = 22 * COIN;
    } else if (nHeight >= 85649) {
        nSubsidy = 10 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SGO: We use certain sporks during IBD, so check to see if they are
