                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Segreto Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SGO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and segreto: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Segreto Core"), this);
    aboutAction->setStatusTip(tr("Show information about Segreto Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Segreto"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SGO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SGO addresses"));
    ...
    openAction->setStatusTip(tr("Open a segreto: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Segreto Core help message to get a list with possible Segreto command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Segreto Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Segreto network", "", count));
}
...
{
    QString strTitle = tr("Segreto Core"); // default title
