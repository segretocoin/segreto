...
/** Utility functions used by the Segreto Qt UI.
 */
namespace GUIUtil
{
...
// Render SGO addresses in monospace font
...
// Parse "segreto:" URI into recipient object, return true on successful parsing
