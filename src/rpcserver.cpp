...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Segreto server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Segreto features */
        {"segreto", "masternode", &masternode, true, true, false},
        {"segreto", "listmasternodes", &listmasternodes, true, true, false},
        {"segreto", "getmasternodecount", &getmasternodecount, true, true, false},
        {"segreto", "masternodeconnect", &masternodeconnect, true, true, false},
        {"segreto", "masternodecurrent", &masternodecurrent, true, true, false},
        {"segreto", "masternodedebug", &masternodedebug, true, true, false},
        {"segreto", "startmasternode", &startmasternode, true, true, false},
        {"segreto", "createmasternodekey", &createmasternodekey, true, true, false},
        {"segreto", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"segreto", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"segreto", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"segreto", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"segreto", "getmasternodescores", &getmasternodescores, true, true, false},
        {"segreto", "mnbudget", &mnbudget, true, true, false},
        {"segreto", "preparebudget", &preparebudget, true, true, false},
        {"segreto", "submitbudget", &submitbudget, true, true, false},
        {"segreto", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"segreto", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"segreto", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"segreto", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"segreto", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"segreto", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"segreto", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"segreto", "checkbudgets", &checkbudgets, true, true, false},
        {"segreto", "mnsync", &mnsync, true, true, false},
        {"segreto", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> segreto-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26993/\n";
}
