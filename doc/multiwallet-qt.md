...
In order to support loading of multiple wallets in segreto-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is segreto.cpp.
...
Changes to segreto.cpp
----------------------
segreto.cpp is the entry point into segreto-qt, and as such, will require some minor modifications to provide hooks for
