...
Intro
-----
Segreto (SGO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Segreto utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run segreto-qt.exe.

Segreto Core is the original Segreto client and it builds the backbone of the network.
However, it downloads and stores the entire history of Segreto transactions;
