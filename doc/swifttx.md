...
This mechanism has been integrated into Bitcore-Node-Segreto which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/segreto/insight-api-segreto#web-socket-api](https://github.com/segreto/insight-api-segreto#web-socket-api)
* API: [https://github.com/segreto/insight-api-segreto#swifttx-transactions](https://github.com/segreto/insight-api-segreto#swifttx-transactions)
...
By default, the Segreto Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Segreto Core daemon:
