...
RESOURCES += src/qt/segreto.qrc src/qt/segreto_locale.qrc

TRANSLATIONS += src/qt/locale/segreto_bg.ts \
                src/qt/locale/segreto_de.ts \
                src/qt/locale/segreto_en.ts \
                src/qt/locale/segreto_es.ts \
                src/qt/locale/segreto_fi.ts \
                src/qt/locale/segreto_fr.ts \
                src/qt/locale/segreto_it.ts \
                src/qt/locale/segreto_ja.ts \
                src/qt/locale/segreto_pl.ts \
                src/qt/locale/segreto_pt.ts \
                src/qt/locale/segreto_ru.ts \
                src/qt/locale/segreto_sk.ts \
                src/qt/locale/segreto_sv.ts \
                src/qt/locale/segreto_vi.ts \
                src/qt/locale/segreto_zh_CN.ts \
                src/qt/locale/segreto_zh_TW.ts
