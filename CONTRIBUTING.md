Contributing to Segreto Core
==================================

The Segreto Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Segreto Core project, and is not to be
confused with overall Segreto Network Protocol consensus changes.

Whether a pull request is merged into Segreto Core rests with the project merge
...
Patches that change Segreto consensus rules are considerably more involved than
...
Where a patch set proposes to change the Segreto consensus, it must have been
...
The project leader is the release manager for each Segreto Core release.
