...
#   c) node1 mines 32 blocks, so now node 0 has 500000SGO, node 1 has 4250SGO, node2 has none.
#   d) node0 sends 601 SGO to node2, in two transactions (301 SGO, then 300 SGO).
